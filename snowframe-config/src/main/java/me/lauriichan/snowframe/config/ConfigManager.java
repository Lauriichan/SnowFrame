...
public final class ConfigManager {
    ...
    public ConfigManager(final SnowFrame<?> app) {
    ...
    public <T, C extends IConfig, E extends IMultiConfigExtension<?, T, C>> MultiConfigWrapper<?, T, C, E> multiWrapper(
        final Class<E> type) {
    ...
    public <T, C extends IConfig, E extends IMultiConfigExtension<?, T, C>> ConfigWrapper<C> multiWrapper(final Class<E> type,
        T element) {
    ...
    public <T, C extends IConfig, E extends IMultiConfigExtension<?, T, C>> ConfigWrapper<C> multiWrapperOrCreate(final Class<E> type,
        T element) {
        MultiConfigWrapper<?, T, C, E> multiWrapper = multiWrapper(type);
        if (multiWrapper == null) {
            return null;
    ...
    public <T, C extends IConfig, E extends IMultiConfigExtension<?, T, C>> C multiConfig(final Class<E> type, T element) {
    ...
    public <T, C extends IConfig, E extends IMultiConfigExtension<?, T, C>> C multiConfigOrCreate(final Class<E> type, T element) {
